...
time = 500  #跌代次數
best_solution = {}                   #紀錄最佳解
initial_solution = {}                #紀錄初始解
profit_array = []                    #紀錄每次跌代最佳獲利
Number_of_iterations = []            #紀錄跌代次數
...
while True:                                 #產生合法初始解
    solution = random_int_list(0,1,15)           #產生15位元01字串
    initial_solution = solution
    best_solution = solution
    if(count_weight(initial_solution,weight)<=capacity[0]):     #檢查是否合法
        break

print("initial solution:",initial_solution)
print("initial profit:",count_value(initial_solution,profit))  #初始解的值沒有記錄到profit_array中
