...
if __name__ == "__main__":
    val = TXT_to_array("C:/Users/craig/Desktop/01knapsack/p07_p.txt")   #用TXT_to_array取得val陣列
    wt = TXT_to_array("C:/Users/craig/Desktop/01knapsack/p07_w.txt")    #用TXT_to_array取得wt陣列
    n = len(val)                                                #取得物品數n
